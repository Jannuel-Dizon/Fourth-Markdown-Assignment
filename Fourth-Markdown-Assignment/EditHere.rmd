...
### Discussions
The primary concern is the relationship of a household having a battery as a source of electricity to its wealth group and grid as source.
The results gathered from the study, through interview, states that there is indeed a relationship to the household's financial income to its source of electricity, as it can be seen from the figure that the wealthier households, or the higher the household's financial income, tend to have a lower percentage of using battery, compared to the other two classes, no matter the area. 
